...
lines long. The following example shows how you might use them:
  ...
  would seem,N<Though I wouldn't go so far as to say they I<overdo>
...
they switched all their manuscripts to DocBook. Pod::PseudoPod is now
the primary parser for PseudoPod, and includes Pod::PseudoPod::DocBook
to generate DocBook output suitable for submission to O'Reilly.
